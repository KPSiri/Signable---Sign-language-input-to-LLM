...
class RealTimeSignLanguageRecognizer:
    def __init__(
        self,
        model_path="app/model/sign_language_recognition_new_40.keras",
        scaler_path="app/model/scaler_new_40.pkl",
        label_encoder_path="app/model/label_encoder_new_40.pkl",
